// Estamos fazendo com que: pra tudo que chame `~/utils` em vez de usar seu respectivo corpo, vamos mockar o que quisermos
jest.mock('~/utils', () => ({
	// jest.fn() (vai ser uma funçâo qualquer que o mock oferece)
	// Assim podemos definir nahora do cenário como vai ser esse retorno
...
import VueMeta from 'vue-meta'; // responsável por por o head dos nossos meta-dados
// Serve para simplificar a monategem de store nos nossos testes
...
describe('Pages:index', () => {
	...
	describe('Mounted', () => {
		it('should request Notification permissions when mounted', () => {
			...
			// Você tem que habilitar no localhost/3000 antes de executar isso
